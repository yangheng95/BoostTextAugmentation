...
tc_config = TC.TCConfigManager.get_tc_config_english()
tc_config.model = (
    TC.BERTTCModelList.BERT
)  # 'BERT' model can be used for DeBERTa or BERT
...
backend = AugmentBackend.ContextualWordEmbsAug
...
augs = BoostingAugmenter.single_augment(
