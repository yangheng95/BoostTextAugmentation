...
from pyabsa.functional import APCConfigManager, Trainer
...
for backend in aug_backends:
    for dataset in [
        ...
        Trainer(apc_config, dataset, device).load_trained_model()
        # try:
        #     shutil.rmtree('integrated_datasets')
        #     shutil.rmtree('source_datasets.backup')
        # except:
        ...
        #                                     rewrite_cache=True,
        #                                     )
        # BoostingAugmenter.apc_classic_augment(apc_config,
        #                                       dataset,
        #                                       train_after_aug=True,
        #                                       rewrite_cache=True,
        #                                       )
        # BoostingAugmenter.apc_mono_augment(apc_config,
        #                                    dataset,
        #                                    train_after_aug=True,
        #                                    rewrite_cache=True,
        #                                    )
